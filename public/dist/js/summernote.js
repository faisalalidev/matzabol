...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      colors: [
        ['#1D4384','#000000', '#424242', '#636363', '#9C9C94', '#CEC6CE', '#EFEFEF', '#F7F7F7'],
        ...
        ['#630000', '#7B3900', '#846300', '#295218', '#083139', '#003163', '#21104A', '#FFFFFF']
      ],
    ...
    var tplDialogs = function (lang, options) {
      var tplImageDialog = function () {
        var body =
            ...
            '<strong>(Resolution of 1024 by 480 pixels looks best.Maximum resolution 2048 by 2048 allowed.File size 1 MB or less.)</strong>' +
