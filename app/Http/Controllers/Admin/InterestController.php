...
class InterestController extends Controller
{
    ...
    public function store(InterestCreateRequest $request)
    {
        ...
        $this->interestRepository->setData($postData);
    ...
    {
        $interest = $this->interestRepository->getDataTable();
...
//            ->rawColumns(['name', 'icon', 'created_at'])//'action',
    ...
    public function manageInterest($filter = 'list', $id = Null)
    {

        switch ($filter) {
            case 'list':
                return view('admin.interests.interest', ['module' => 'Interests']);
                break;
            case 'create':
                return view('admin.interests.add_interest', ['module' => "Interests"]);
                break;
//            case 'active':
...
//                break;
            case 'delete':
                ...
                Alert::success('Interest Successfully Deleted !');
                return Redirect::back();
                break;
            default:
                abort(404);
